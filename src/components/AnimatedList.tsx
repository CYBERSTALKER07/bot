  ...
  return (
    <div className={`relative ${width} ${className}`} style={{ width }}>
        ...
        {items.map((item, index) => (
          ...
          >
            {renderItem ? (
              ...
              <div className={`p-4 bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors ${selectedIndex === index ? 'bg-gray-200 dark:bg-gray-700' : ''} ${itemClassName}`}>
      ...
      {showGradients && (
        <>
          <div
            className="absolute top-0 left-0 right-0 h-[50px] bg-linear-to-b from-white dark:from-black to-transparent pointer-events-none transition-opacity duration-300 ease"
            style={{ opacity: topGradientOpacity }}
          ></div>
          <div
            className="absolute bottom-0 left-0 right-0 h-[100px] bg-linear-to-t from-white dark:from-black to-transparent pointer-events-none transition-opacity duration-300 ease"
