...
export default function ForStudentsPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full backdrop-blur-xl z-50 bg-white/95 border-b border-gray-100 shadow-xs">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <div className="flex items-center space-x-4">
              <div className="p-3 rounded-2xl bg-linear-to-br from-purple-600 to-purple-800 shadow-lg">
            ...
            <div className="hidden md:flex text-wrap items-center space-x-1">
              ...
              <Link to="/register" className="px-8 py-3 bg-linear-to-r from-purple-600 to-purple-800 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-purple-900 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
                Get Started
              </Link>
      ...
      <section ref={heroRef} className="relative overflow-hidden bg-linear-to-br from-purple-900 via-purple-800 to-indigo-900 min-h-screen flex items-center">
        {/* Enhanced Decorative Elements */}
        <div className="absolute inset-0 pointer-events-none">
          {/* Animated gradient orbs */}
          <div className="absolute top-20 left-20 w-96 h-96 bg-linear-to-r from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-20 w-80 h-80 bg-linear-to-r from-blue-400/20 to-cyan-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
            ...
            <div className="max-w-lg mx-auto mb-16">
              <form onSubmit={handleSignup} className="flex gap-4 p-2 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl hover:shadow-3xl transition-shadow">
                <input
                  ...
                  className="flex-1 px-6 py-4 text-lg text-gray-900 placeholder-gray-500 border-0 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-purple-500 bg-transparent"
                  required
                />
                <button 
                  type="submit"
                  className="px-8 py-4 bg-linear-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Get Started
                </button>
              </form>
      ...
      <section ref={featuresRef} className="py-32 px-6 lg:px-8 bg-linear-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
            ...
            {features.map((feature, index) => (
              <div key={index} className="feature-card group">
                <div className="bg-white rounded-3xl p-10 shadow-xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-6 border border-gray-100 h-full">
                  <div className={`inline-flex items-center justify-center w-28 h-28 rounded-3xl bg-linear-to-br ${feature.gradient} mb-8 group-hover:scale-110 transition-transform duration-300 shadow-2xl`}>
                    <div className="text-white">
                      {feature.icon}
                    </div>
                  </div>
      ...
      <section ref={companiesRef} className="py-32 px-6 lg:px-8 bg-linear-to-br from-purple-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
            ...
            {filteredCompanies.slice(0, 12).map((company, index) => (
              <div key={index} className="company-logo group">
                <div className="bg-white rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 border border-gray-100">
                  <div className="w-16 h-16 mx-auto bg-linear-to-br from-purple-600 to-purple-800 rounded-2xl flex items-center justify-center text-white text-xl font-bold group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            {contentFeatures.map((feature, index) => (
              <div key={index} className={`content-section grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-purple-600 to-purple-800 mb-8 shadow-lg`}>
                    <div className="text-white">
                      {feature.icon}
                    </div>
                  </div>
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}>
                  <div className="relative group">
                    <div className="absolute inset-0 bg-linear-to-br from-purple-600 to-purple-800 rounded-3xl transform rotate-3 group-hover:rotate-6 transition-transform"></div>
                    <img 
                      src={feature.image} 
                      alt={feature.title}
      ...
      <section ref={resourcesRef} className="py-32 px-6 lg:px-8 bg-linear-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-8">
            ...
            {resources.map((resource, index) => (
              <div key={index} className="resource-card group">
                <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-4 border border-gray-100 h-full">
                  <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-linear-to-r ${resource.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}>
                    <div className="text-white">
                      {resource.icon}
                    </div>
                  </div>
      ...
      <section ref={appDemoRef} className="py-32 px-6 lg:px-8 bg-linear-to-br from-purple-900 via-purple-800 to-indigo-900">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="px-8 py-4 bg-linear-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold rounded-2xl text-lg shadow-xl hover:shadow-2xl transform hover:scale-105">
                  Download for iOS
                </Button>
            ...
            <div className="flex justify-center">
              <div className="app-demo relative">
                <div className="absolute inset-0 bg-linear-to-br from-yellow-400 to-orange-500 rounded-3xl transform rotate-6 scale-105 blur-xl opacity-70"></div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="relative">
                        <div className="w-10 h-10 bg-linear-to-br from-purple-600 to-purple-800 rounded-full flex items-center justify-center">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={i} className="bg-linear-to-r from-gray-50 to-gray-100 rounded-2xl p-4 border border-gray-200">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                              <div className="w-10 h-10 bg-linear-to-br from-purple-600 to-purple-800 rounded-xl flex items-center justify-center text-white text-sm font-bold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="testimonial-card">
                <div className="bg-linear-to-br from-purple-50 via-white to-indigo-50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
      ...
      {/* Enhanced Final CTA */}
      <section ref={ctaRef} className="py-32 px-6 lg:px-8 bg-linear-to-br from-purple-900 via-purple-800 to-indigo-900 relative overflow-hidden">
        {/* Background effects */}
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-16 border border-white/20 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
              <Button 
                ...
                className="px-12 py-6 bg-linear-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold rounded-2xl transition-all shadow-2xl hover:shadow-3xl text-xl transform hover:scale-105"
              >
                Start Free Today
              </Button>
