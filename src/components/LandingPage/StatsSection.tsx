      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center text-white">
          <div className="stat-card space-y-4 transform hover:scale-105 transition-transform duration-300 rotate-1">
            <div className="stat-glow absolute inset-0 bg-asu-gold/30 rounded-full blur-2xl"></div>
            <div className="stat-number text-5xl md:text-6xl font-bold bg-gradient-to-b from-white to-asu-gold bg-clip-text text-transparent relative z-10" data-target="15000">0</div>
          ...
          <div className="stat-card space-y-4 transform hover:scale-105 transition-transform duration-300 -rotate-1">
            <div className="stat-glow absolute inset-0 bg-asu-gold/30 rounded-full blur-2xl"></div>
            <div className="stat-number text-5xl md:text-6xl font-bold bg-gradient-to-b from-white to-asu-gold bg-clip-text text-transparent relative z-10" data-target="500">0</div>
          ...
          <div className="stat-card space-y-4 transform hover:scale-105 transition-transform duration-300 rotate-0.5">
            <div className="stat-glow absolute inset-0 bg-asu-gold/30 rounded-full blur-2xl"></div>
            <div className="stat-number text-5xl md:text-6xl font-bold bg-gradient-to-b from-white to-asu-gold bg-clip-text text-transparent relative z-10" data-target="2000">0</div>
          ...
          <div className="stat-card space-y-4 transform hover:scale-105 transition-transform duration-300 -rotate-0.5">
            <div className="stat-glow absolute inset-0 bg-asu-gold/30 rounded-full blur-2xl"></div>
            <div className="stat-number text-5xl md:text-6xl font-bold bg-gradient-to-b from-white to-asu-gold bg-clip-text text-transparent relative z-10" data-target="95">0</div>
