    ...
    <section className={`py-24 relative overflow-hidden transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`relative rounded-3xl p-8 shadow-2xl border transition-colors duration-300 ${
            isDark 
                ...
                <svg className="w-full h-full" viewBox="0 0 300 300" preserveAspectRatio="xMidYMid slice">
                  <defs>
                    <linearGradient id={`pathGradient${isDark ? 'Dark' : ''}`} x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor={isDark ? "#E3FF70" : "#FFC627"} stopOpacity="0.6" />
                      <stop offset="100%" stopColor={isDark ? "#E3FF70" : "#8C1D40"} stopOpacity="0.6" />
                    </linearGradient>
                  </defs>
                  <path
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-4">
              <div className={`w-12 h-12 border-2 rounded-xl flex items-center justify-center flex-shrink-0 ${
                isDark 
