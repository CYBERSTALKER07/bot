...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  const variants = {
    ...
    info: 'bg-info-50 border-info-200 text-info-800 dark:bg-info-900/20 dark:border-info-700 dark:text-info-300',
  };
  ...
  return (
    <div
      className={cn(
        'relative flex items-start gap-3 p-4 border rounded-lg shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out animate-slide-down',
        variants[toast.type]
      )}
    >
