    ...
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-red-800 to-gray-900 flex overflow-hidden">
      <div className="w-full max-w-none bg-white shadow-2xl flex">
        ...
        <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
          ...
          {/* Real Campus/Success Image */}
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-80" 
               style={{
                 backgroundImage: `url('https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80')`
               }}>
          </div>
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-white p-12">
            <div className="text-center max-w-md">
              <h2 className="text-4xl font-bold mb-6 leading-tight">
                Welcome Back to <span className="text-yellow-400">ASU Handshake</span>
              </h2>
              ...
              <div className="mt-8 bg-yellow-400/20 rounded-2xl p-6 backdrop-blur-sm border border-yellow-400/40">
                <div className="flex items-center justify-center space-x-3 mb-3">
                  ...
                  <span className="font-bold text-yellow-400 text-xl">Your Next Opportunity Awaits</span>
                </div>
                <p className="text-gray-200">
                  Discover new career possibilities with every login
                </p>
              </div>
            </div>
            ...
            <div className="absolute bottom-8 left-8 bg-white/95 rounded-xl p-4 shadow-xl">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-bold text-gray-900">Trusted by ASU Students</span>
              </div>
            </div>
