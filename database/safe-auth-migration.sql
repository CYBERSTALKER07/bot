-- Safe Authentication Database Setup for School App
-- This migration handles existing objects and only creates what's missing
...
-- Create indexes for profiles (IF NOT EXISTS is safe)
...
-- Drop existing policies if they exist, then recreate them
DROP POLICY IF EXISTS "Comments are viewable if post is viewable" ON comments;
...
-- This safe migration handles existing objects and creates missing ones.